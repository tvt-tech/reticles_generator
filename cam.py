...
class MainWindow(QDialog):
    ...
    def __init__(self, parent, canvas):
        ...
        self.viewfinder.setLayout(QGridLayout())

        self.overlay = QLabel()

        self.viewfinder.layout().addWidget(self.overlay)

        self.overlay.setStyleSheet("""background-color: transparent;""")
        self.overlay.setAlignment(Qt.AlignTop|Qt.AlignCenter)
    ...
    def select_camera(self, i):
        ...
        # w, h = self.viewfinder.width(), self.viewfinder.height()
        ...
        self.overlay.setPixmap(self.canvas)
